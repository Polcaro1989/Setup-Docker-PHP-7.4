...
<head>
  ...
  <meta charset="utf-8" />
  <title>Portfólio|Abraão</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta content="Portfólio" name="descrição" />
  <meta content="Portfólio" name="author Abraão-Martins" />
  <!-- App favicon -->
  <!-- Seus metadados aqui -->
  <?php
...
<body style="background-color:#ffc93b;">
                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4 overlay">
                    ...
                    <div class="mb-4">
                      ...
                      <a href="index.html" class="d-block">
                        <img src="uploads/static/79539414testimonial-removebg-preview.png" class="mb-n0" alt="" height="30">
                      </a>
                    </div>
                    <div class="bg-auth">
                      <?php
                  ...
                  <div class="p-lg-5 p-4">
                    ...
                    <div class="mt-4">
                      ...
                      <form class="user" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post">
                        ...
                        <a class="nav-link mr-2 nav-link-label " href="http://localhost:8085/public_html/">
