            ...
            <div class="row">
                ...
                <div class="col-xxl-9">
                    <div class="card mt-xxl-n5">
                        ...
                        if (isset($_POST['save'])) {
                            $testimony_name = $_POST['testimony_name']; // Nome da variável alterado
                            $message = $_POST['message'];
                            $position = $_POST['position'];

                            if (strlen($testimony_name) < 1) {
                            ...
                            $image_name = basename($_FILES["ufile"]["name"]); // Use outra variável para o nome do arquivo
                            $random_digit = rand(0000, 9999);
                            $new_file_name = $random_digit . $image_name; // Use a nova variável para o nome do arquivo
                            move_uploaded_file($tmp_name, "$uploads_dir/$new_file_name");
                            //...


                            if ($status == "OK") {
                                $stmt = $con->prepare("INSERT INTO testimony (testimony_name, message, position, ufile) VALUES (?, ?, ?, ?)");
                                $stmt->bindParam(1, $testimony_name);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="firstnameinput" name="testimony_name"> <!-- Nome do campo alterado -->
                                                </div>
                                            </div>
                                            <div class=" col-lg-6">
                                                <div class="mb-3">
