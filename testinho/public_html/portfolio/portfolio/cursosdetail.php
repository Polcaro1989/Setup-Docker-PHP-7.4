            ...
            <?php if (isset($curso)) : ?>
                <div class="col-lg-12 col-md-6 col-12 text-center logo">
                    ...
                    <li class='atf-single-resume d-block wow fadeIn' data-wow-duration='1s' data-wow-delay='0.2s' data-wow-offset='0'>
                        <img class='rounded-start img-fluid h-100 object-fit-cover' src='dashboard/uploads/cursos/<?= isset($curso['ufile']) ? $curso['ufile'] : 'caminho/para/imagem/default.jpg'; ?>' alt='<?= isset($curso['ufile']) ? $curso['ufile'] : 'Imagem não definida'; ?>'>
                        <div>
