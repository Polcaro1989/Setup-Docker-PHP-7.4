...
?>
        ...
        <a href="https://devabraao.tech/" class="logo logo-dark">
            <span class="logo-sm">
        ...
        <a href="https://devabraao.tech/" class="logo logo-light">
            <span class="logo-sm">
                <img src="uploads/logo/<?php print $ufile ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="dashboard" class="nav-link" data-key="t-analytics"> <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Portfólio</span></a>
                </li>
                <li class="nav-item">
