                    ...
                    <div class="col-md-12 col-lg-7 col-12 atf-border-right">
                        ...
                        <form id="myForm" name="ContactForm" method="post" enctype="multipart/form-data">
                            <div class="atf-main-contact">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                    <textarea class="form-control" name="message" placeholder="Message" required="required"></textarea></div>
                                </div>
                                <div class="col-md-12">
                                    <div class="atf-contact-btn">
                                        <button type="submit" class="btn atf-themes-btn" name="submit" value="send your message"><span class="text-white pr-3"><i class="fas fa-paper-plane"></i></span>Send Message</button>
                                    </div>
                                </div>
                            </div>
                        </form><br>
